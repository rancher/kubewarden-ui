...
import { SBOMSCANNER, SBOMSCANNER_REPOS, CNPG, CNPG_REPOS } from '@sbomscanner/types';
import { handleGrowl } from '@sbomscanner/utils/handle-growl';
import { refreshCharts, getLatestVersion } from '@sbomscanner/utils/chart';
import InstallWizard from '@sbomscanner/components/common/InstallWizard';
