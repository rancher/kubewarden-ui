...
<script>
import { RESOURCE, PRODUCT_NAME, PAGE } from '@sbomscanner/types';
// import SevereVulnerabilitiesItem from '@sbomscanner/components/common/SevereVulnerabilitiesItem.vue';
