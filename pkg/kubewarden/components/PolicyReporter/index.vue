...
export default {
  ...
  computed: {
    ...
    hasClusterPolicyReportSchema() {
      return this.$store.getters['cluster/schemaFor'](OPEN_REPORTS.CLUSTER_POLICY_REPORT.TYPE);
    },

    hasPolicyReportSchema() {
      return this.$store.getters['cluster/schemaFor'](OPEN_REPORTS.POLICY_REPORT.TYPE);
    },
